...
import type { Permission } from "../lib/api/types.ts";

// ============================================================================
// 图标类型定义
// ============================================================================

/** 图标名称类型 - 对应 lucide-preact 图标 */
...
export const MENU_ITEMS: MenuItem[] = [
  { title: "仪表盘", icon: "layout-dashboard", href: "/dashboard" },
  { title: "用户管理", icon: "users", href: "/users" },
  {
    ...
    href: "/documents",
    children: [
      { title: "文档管理", icon: "file-text", href: "/documents" },
      { title: "文件存储", icon: "folder-open", href: "/files" },
    ],
  },
  {
    title: "业务运营",
    ...
    href: "/analytics",
    children: [
      { title: "数据分析", icon: "bar-chart-3", href: "/analytics" },
      { title: "消息中心", icon: "mail", href: "/messages" },
      { title: "日程安排", icon: "calendar", href: "/calendar" },
    ],
  },
  { title: "账号与权限", icon: "shield-check", href: "/accounts" },
  {
    title: "系统设置",
    icon: "settings",
    href: "/settings",
