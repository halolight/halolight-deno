...
const socialLinks = [
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/halolight",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Discord",
    href: "https://discord.gg/halolight",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col items-center md:flex-row md:justify-between">
              ...
              <form className="flex w-full max-w-md gap-2">
                <input
                  type="email"
                  placeholder="输入您的邮箱"
                  className="flex-1 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
                <button
                  type="submit"
          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex items-center gap-4">
              <a href="/" className="flex items-center gap-2">
                <img src="/logo.svg" alt="HaloLight" className="h-8 w-8" />
                <span className="text-lg font-bold text-gray-900 dark:text-white">
                  HaloLight
                </span>
              </a>
              <span className="text-sm text-gray-500 dark:text-gray-400">
                © {currentYear} HaloLight. 保留所有权利。
              </span>
            </div>
...
export function FooterSimple({ className }: { className?: string }) {
  const currentYear = new Date().getFullYear();
...
export function AdminFooter({ className }: { className?: string }) {
  ...
  return (
    <footer
      className={cn(
        "border-t border-gray-200/50 dark:border-gray-700/50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm",
        className,
      )}
    >
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-2 py-4 text-sm text-gray-500 dark:text-gray-400 sm:flex-row">
          {/* 版权信息 */}
